...
$(document).ready(function() {
    ...
    console.log($('.modama_datetime input').attr('data-format'));
    $('.modama_datetime').each(function( idx) {
      var fmt = $(this).children('input:first').attr('data-format');
